...
| [ADR-0008](0008-third-party-skill-libraries-are-the-operators-own-install.md) | A third-party skill library is never vendored into this bundle; its bytes stay upstream and adaptation requires a NOTICE donor entry | accepted in part | 2026-08-07 |
...
| [ADR-0015](0015-local-evaluation-is-the-rightsizing-promotion-boundary.md) | Local evaluation is the rightsizing promotion boundary | Accepted | 2026-08-12 |
